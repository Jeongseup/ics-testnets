#!/bin/bash
# Set up a station service to join the station-1 chain.
...
NODE_HOME=~/.station
NODE_MONIKER=station
# ***

CHAIN_BINARY_URL='https://raw.githubusercontent.com/stationlove-ventures/ics-testnets/main/game-of-chains-2022/station/prop-9/stationd'
CHAIN_BINARY='stationd'
CHAIN_ID=station-1
...
# rm -rf station
# git clone https://github.com/stationlove-ventures/station.git
# cd station
...
echo "Description=station service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the station service:"
